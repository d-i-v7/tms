...
<head>
    ...
    <title>TMS {For Bilicsan Technologies}</title>
...
<body>
 ...
 <!--**********************************
        ...
        ***********************************-->
        ...
        <!-- Qaybtaan Waxaa ka MAqan Chating Section -->
            ...
            <div class="header-content">
				...
				<div class="sub-header">
					...
					<div class="d-flex align-items-center">
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1">Quaterly</a>
						<a href="javascript:void(0);" class="btn btn-xs btn-primary light">Year</a>
						<a href="javascript:void(0);" class="btn btn-xs btn-primary light">Ever</a>
					</div>
				</div>
			</div>
        </div>
