        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				...
				<div class="copyright">
					<p><strong>Tailor Management System</strong> © <?php echo date("Y");?> All Rights Reserved</p>
					<p class="fs-12">Made with <span class="heart"></span> by Bilicsan Technologies</p>
				</div>
			</div>
        </div>
        <!--**********************************
